...
Note : Sebagai fungsi pada parent dapat diturunkan ke child component melalui props. Sedangkan jika ingin melakukan hal sebaliknya, kita dapat menggunakan `ref`.
